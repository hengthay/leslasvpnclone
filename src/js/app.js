...
document.addEventListener('DOMContentLoaded', () => {
    ...
    generateTestimonials(); // First, populate the slides
    ...
    const swiper = new Swiper('.testimonialSwiper', {
        ...
        autoplay: {
            ...
            disableOnInteraction: false, // Set to false so autoplay doesn't stop on user interaction
        },
        pagination: {
    ...
    // If you ever dynamically add/remove slides AFTER initialization, you might need:
    // swiper.update(); // to update Swiper's internal state
    // swiper.autoplay.start(); // to ensure autoplay starts if it was stopped
});